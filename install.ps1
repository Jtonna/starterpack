...
$Manifest = @(
    ...
    "docs/.starter_pack_docs/workflows/WORKFLOW_IMPLEMENTATION.xml"
    "docs/.starter_pack_docs/workflows/WORKFLOW_DOCS.xml"
    "docs/.starter_pack_docs/workflows/WORKFLOW_PR.xml"
    "docs/.starter_pack_docs/beads_sync.md"
