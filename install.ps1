...
& {
    ...
    $Manifest = @(
        ...
        ".starterpack/lifecycle/planning.xml"
        ".starterpack/lifecycle/implementation.xml"
        ".starterpack/lifecycle/docs.xml"
        ".starterpack/lifecycle/pr.xml"
        ".starterpack/behaviors/commit-discipline.xml"
        ".starterpack/behaviors/escalation.xml"
        ".starterpack/behaviors/scope-enforcement.xml"
        ".starterpack/behaviors/sub-task-tracking.xml"
        ".starterpack/behaviors/documentation-structure.xml"
        ".starterpack/behaviors/pr-template.xml"
        ".starterpack/behaviors/branching.xml"
        ".starterpack/config/models.xml"
        ".starterpack/config/beads.xml"
        ".starterpack/config/agent-teams.xml"
