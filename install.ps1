...
& {
    ...
    $Manifest = @(
        "CLAUDE.md"
        ".gitattributes"
        ".starterpack2/agent_instructions/BEHAVIORS_MANIFEST.xml"
        ".starterpack2/agent_instructions/LIFECYCLE_MANIFEST.xml"
        ".starterpack2/agent_instructions/AGENT_TEAMS.xml"
        ".starterpack2/agent_instructions/behaviors/git-with-beads.xml"
        ".starterpack2/agent_instructions/behaviors/escalation.xml"
        ".starterpack2/agent_instructions/behaviors/scope-enforcement.xml"
        ...
        ".starterpack2/agent_instructions/lifecycle/docs.xml"
        ".starterpack2/agent_instructions/lifecycle/pr.xml"
        ".starterpack2/beads_sync.md"
        ".starterpack2/hooks/post-merge"
